...
<div class="main__body">
    ...
    <div class="feed">
        <div class="storyReel">
            ...
            >
                <%--                <!-- <img--%>
                <%--                        class="user_avatar story_avatar"--%>
                <%--                        src="data:image/png;base64,"--%>
                <%--                        alt=""--%>
                <%--                /> -->--%>
        ...
        <div class="post_container">
            <table class="post_container">
                <tbody class="post_container">

                <c:forEach var="post" items="${sessionScopeScope.posts}">
                       ...
                       <div class="post">
                           <div class="post__top">
                               ...
                               <div class="post__topInfo">
                                   <h3><c:out value="${post.getUserName()}"/></h3>
                               </div>
                           </div>

                           <div class="post__bottom">
                               <p><c:out value="${post.getTextBody()}"/></p>
                           </div>

                           <div class="post__options">
                               <div class="post__option">
                                   <span class="material-icons"> thumb_up </span>
                                   <p><c:out value="${post.getLikes()}"/></p>
                               </div>
